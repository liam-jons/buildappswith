 ...
 * It provides authentication middleware with improved performance,
 * flexible configuration, and performance monitoring.
 */

import { NextRequest, NextResponse } from "next/server";
import { createClerkExpressMiddleware } from "./adapters/clerk-express/adapter";
