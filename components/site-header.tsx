...
// Import shared ViewingPreferences component and feature flag wrapper
import ViewingPreferences from "@/components/marketing/ui/viewing-preferences";
import { FeatureFlagWrapper, SimplifiedViewingPreferences } from "@/components/feature-flag-wrapper";
      ...
      <header className="fixed left-0 top-0 z-50 w-full translate-y-[-1rem] animate-fade-in border-b opacity-0 backdrop-blur-[12px] [--animation-delay:600ms]">
        <div className="container flex h-[3.5rem] items-center justify-between">
          ...
          <div className="ml-auto flex h-full items-center">
            {/* Viewing Preferences Buttons - Temporarily disabled due to rendering issues */}
            <SimplifiedViewingPreferences className="hidden md:block" />
            <SimplifiedViewingPreferences variant="minimal" className="md:hidden" />
