    ...
    >
      <div className="w-full max-w-7xl mx-auto px-6">
        <div className="h-[400px] md:h-[400px] overflow-hidden shadow-xl w-full border border-border rounded-xl bg-secondary relative z-20">
          <div 
            className="absolute inset-0 w-full h-full object-cover object-right md:object-center bg-gradient-to-r from-purple-600 to-blue-600"
          />
          <div className="absolute inset-0 -top-32 md:-top-40 flex flex-col items-center justify-center">
            ...
            <div className="absolute bottom-10 flex flex-col items-center justify-center gap-2">
              ...
              <span className="text-white text-sm">No commitment required</span>
            </div>
          </div>
        </div>
      </div>
