            ...
            <Card>
              ...
              <CardContent>
                <p>
                  ...
                  emphasizes learning by doing, with a curriculum focused on practical, immediate application.
                </p>
              </CardContent>
            </Card>
        ...
        <section className="mb-12">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 rounded-lg p-6 mb-6">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>A transparent validation system that recognizes quality</li>
