# Buildappswith Unused Components Analysis
...
| portfolio-showcase | portfolio-showcase.tsx | ./components/profile/portfolio-showcase.tsx | 2025-04-28 |
...
| types | types.ts | ./lib/auth/types.ts | 2025-04-27 |


### Stripe Integration (2 components)

| Component | File | Path | Last Modified |
|-----------|------|------|--------------|
| stripe-client | stripe-client.ts | ./lib/stripe/stripe-client.ts | 2025-04-28 |
| stripe-server | stripe-server.ts | ./lib/stripe/stripe-server.ts | 2025-04-28 |


### Other Components (120 components)

| Component | File | Path | Last Modified |
|-----------|------|------|--------------|
| admin-nav | admin-nav.tsx | ./components/admin/admin-nav.tsx | 2025-04-23 |
| animated-heading | animated-heading.tsx | ./components/custom/animated-heading.tsx | 2025-04-28 |
| api-protection | api-protection.ts | ./lib/middleware/api-protection.ts | 2025-04-26 |
| app-service | app-service.ts | ./lib/marketplace/app-service.ts | 2025-04-28 |
| architecture-utils | architecture-utils.ts | ./scripts/architecture-utils.ts | 2025-04-27 |
| builder-profile-service | builder-profile-service.ts | ./lib/services/builder-profile-service.ts | 2025-04-28 |
| builder-service | builder-service.ts | ./lib/services/builder-service.ts | 2025-04-23 |
| builder | builder.ts | ./lib/types/builder.ts | 2025-04-28 |
| check-current-status | check-current-status.js | ./scripts/check-current-status.js | 2025-04-21 |
| check-final | check-final.js | ./scripts/check-final.js | 2025-04-20 |
| check-git-branches | check-git-branches.js | ./scripts/check-git-branches.js | 2025-04-21 |
| check-migration-history | check-migration-history.js | ./scripts/check-migration-history.js | 2025-04-21 |
| check-migration-status | check-migration-status.js | ./scripts/check-migration-status.js | 2025-04-21 |
| check-typescript-fixes | check-typescript-fixes.js | ./scripts/check-typescript-fixes.js | 2025-04-20 |
| clerk-provider | clerk-provider.tsx | ./components/providers/clerk-provider.tsx | 2025-04-24 |
| client | client.tsx | ./app/profile/[id]/client.tsx | 2025-04-28 |
| config | config.ts | ./lib/middleware/config.ts | 2025-04-26 |
| config | config.js | ./scripts/datadog/config.js | 2025-04-26 |
| contact-form | contact-form.tsx | ./components/contact/contact-form.tsx | 2025-04-28 |
| coverage-processor | coverage-processor.js | ./scripts/datadog/coverage-processor.js | 2025-04-26 |
| create-baseline-migration | create-baseline-migration.js | ./scripts/create-baseline-migration.js | 2025-04-21 |
| create-dashboard | create-dashboard.js | ./scripts/datadog/dashboards/create-dashboard.js | 2025-04-26 |
| create-dummy-profiles | create-dummy-profiles.ts | ./scripts/seed-data/create-dummy-profiles.ts | 2025-04-23 |
| create-profiles | create-profiles.ts | ./scripts/seed-data/create-profiles.ts | 2025-04-23 |
| create-unused-features-analyzer | create-unused-features-analyzer.ts | ./scripts/create-unused-features-analyzer.ts | 2025-04-27 |
| csrf | csrf.ts | ./lib/csrf.ts | 2025-04-23 |
| data-service | data-service.ts | ./lib/marketplace/data-service.ts | 2025-04-28 |
| datadog-config | datadog-config.js | ./datadog-config.js | 2025-04-26 |
| datadog-test-agent | datadog-test-agent.js | ./datadog-test-agent.js | 2025-04-26 |
...
| prisma-extensions | prisma-extensions.ts | ./lib/prisma-extensions.ts | 2025-04-20 |
...
| test-utils | test-utils.ts | ./lib/middleware/test-utils.ts | 2025-04-26 |
