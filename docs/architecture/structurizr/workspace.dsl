    ...
    model {
        ...
        buildappswith = softwareSystem "Buildappswith Platform" "A platform that democratizes AI application development through marketplace and educational resources" {
            ...
            authenticationservice {
                ...
                auth = component "auth" "Authentication Component" tags "Technical Debt"
                ...
                protected_route = component "protected-route" "UI Component" tags "Legacy"
            ...
            paymentservice {
                ...
                route = component "route" "API Endpoint" tags "Technical Debt"
                route = component "route" "API Endpoint" tags "Technical Debt"
                route = component "route" "API Endpoint"
            }
